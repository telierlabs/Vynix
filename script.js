        ...
        // ---------- Navigasi Umum (Diperbarui dengan 'subscription') ----------
        ...
        function showPage(page) {
            ...
            const pageMap = {
                ...
                'subscription': ['subscription-page', 'Langganan'] // BARU
            };
        ...
        function updateVideoControls(isPlay) {
            ...
            if (isPlay) {
                ...
                document.getElementById('video-controls').style.opacity = '0'; // Sembunyikan kontrol saat playing
            } else {
                // Set state ke Paused
                videoPlayer.classList.add('paused');
                mainPlayIcon.className = 'fas fa-play';
                centerPlayIcon.className = 'fas fa-play';
                document.getElementById('video-controls').style.opacity = '1'; // Tampilkan kontrol saat paused
            }
        }
        ...
        function toggleMute() {
            ...
            if (volumeIcon.classList.contains('fa-volume-up')) {
                ...
                document.getElementById('volume-slider').value = 50; // Kembali ke volume default
            }
        }
        ...
        function openVideoPlayer(movieTitle) {
            ...
            // Perbarui nama video di dalam player dummy
        ...
        // ---------- Fungsi GO BACK DIPERBAIKI TOTAL ----------
        ...
        function goBack() {
            ...
            if (previousPage === 'home') {
                ...
                if (currentMovie) {
                    // Re-render detail page without pushing to stack (it was popped)
                    showMovieDetail(currentMovie.title);
                    backStack.pop(); // Hapus duplikat dari stack
                } else {
                     showHomePage();
                }
            } else {
        ...
        function startSubscription(planName) {
            ...
            alert(`Anda memilih ${planName}. Selamat! Fitur ini adalah dummy. Di versi nyata, Anda akan diarahkan ke halaman pembayaran.`);
        }
